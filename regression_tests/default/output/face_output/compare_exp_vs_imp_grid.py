...
def check_connections_ids_and_area(output="face_area.h5",verbose=True):
  ...
  if verbose:
    print(f"Number of internal connections: {n_connections_internal} / ",end="")
...
if __name__ == "__main__":
  err = check_connections_ids_and_area(verbose = False)
  if err: exit(-1)
  else: exit(0)
