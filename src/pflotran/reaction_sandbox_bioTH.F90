...
!!!!!!!!!!!!!!!!!!!
  ...
  mu_B_mob_residual =     -1* mu_B_mob*L_water + ((this%alpha_vel*global_auxvar%darcy_vel(iphase))**this%beta_vel)*this%rate_B_2*(Vaq - this%background_concentration_B)* L_water  
