...
subroutine GeneralSecHeatAuxVarCompute(sec_heat_vars,global_auxvar, &
                                       therm_conductivity,dencpr, &
                                       option)
  !
  ! Computes secondary auxillary variables in each
  ! grid cell for heat transfer only
  !
  ! Author: Satish Karra, LANL, adapted for General Mode by David Fukuyama
  ! Date: 06/5/12, DF: 02/28/23
  ! 
...
end subroutine GeneralSecHeatAuxVarCompute
