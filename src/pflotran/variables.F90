...
#include "petsc/finclude/petscsys.h"
  ...
  PetscInt, parameter, public :: FACE_PERMEABILITY       = 201
  PetscInt, parameter, public :: FACE_AREA               = 202
  PetscInt, parameter, public :: FACE_NON_ORTHO_ANGLE    = 203
  PetscInt, parameter, public :: FACE_UPWIND_FRACTION    = 204
  PetscInt, parameter, public :: FACE_DISTANCE_BETWEEN_CENTER = 205
  PetscInt, parameter, public :: FACE_NORMAL_X            = 206
  PetscInt, parameter, public :: FACE_NORMAL_Y            = 207
  PetscInt, parameter, public :: FACE_NORMAL_Z            = 208
  PetscInt, parameter, public :: FACE_CELL_CENTER_VECTOR_X = 209
  PetscInt, parameter, public :: FACE_CELL_CENTER_VECTOR_Y = 210
  PetscInt, parameter, public :: FACE_CELL_CENTER_VECTOR_Z = 211
