...
#include "petsc/finclude/petscsys.h"
  ...
  public :: ReactionCreate, &
            ...
            ReactionThresholdInhibitionSmoothstep
...
subroutine ReactionThresholdInhibition2(concentration,threshold_concentration, &
                                        threshold_constant,inhibition_factor,derivative)
  !
  ! Calculates threshold inhibition for a reactant
  !
  ! Author: Peishi Jiang
...
subroutine ReactionThresholdInhibitionSmoothstep(concentration,threshold_concentration, &
                                        interval,inhibition_factor,derivative)
  !
  ! Calculates threshold inhibition for a reactant
  !
  ! Author: Peishi Jiang
  ...
  if (z < 0.) then
    ...
    derivative = (6.d0*z - 6.d0*z**2) / (interval*concentration*LOG(10.d0))
  endif

end subroutine ReactionThresholdInhibitionSmoothstep
